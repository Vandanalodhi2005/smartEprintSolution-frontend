            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                         ...
                         <span className="text-xs font-black text-blue-600">Category Logic</span>
                    </div>
                ...
                {!isFormOpen && (
                    <button
                        ...
                        className="px-8 py-5 bg-slate-900 text-white rounded-2xl font-black text-sm hover:bg-blue-600 transition-all shadow-2xl shadow-slate-200 active:scale-95 flex items-center gap-3"
                    >
                        <Plus size={20} />
                        Initialize Node
                    </button>
            ...
            <div className="space-y-4">
                {(errorDelete || errorCreate || errorUpdate) && (
                    <div className="p-6 bg-rose-50 text-rose-600 rounded-3xl flex items-center gap-4 border-2 border-rose-100 animate-in slide-in-from-left duration-500">
                        <AlertCircle size={24} />
                        <span className="font-black text-sm">{errorDelete || errorCreate || errorUpdate}</span>
                    </div>
                )}
                ...
                {successDelete && (
                    <div className="p-6 bg-emerald-50 text-emerald-600 rounded-3xl flex items-center gap-4 border-2 border-emerald-100 animate-in slide-in-from-left duration-500">
                        ...
                        <span className="font-black text-sm">Category node removed from registry.</span>
                    </div>
                )}
            </div>
            ...
            {isFormOpen && (
                <div className="bg-white rounded-[3rem] border-2 border-slate-50 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                    <div className="bg-slate-900 px-10 py-8 flex justify-between items-center relative overflow-hidden">
                        ...
                        <h3 className="font-black text-white flex items-center gap-4 text-sm relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="p-12">
                        <div className="space-y-4">
                            <label className="text-sm font-black text-slate-400 ml-2">Display Name</label>
                            <div className="flex flex-col xl:flex-row gap-6">
                                ...
                                <button
                                    ...
                                    className="px-12 py-5 bg-blue-600 text-white font-black rounded-2xl hover:bg-blue-500 transition-all shadow-xl shadow-blue-100 disabled:opacity-50 flex items-center justify-center gap-3 text-base active:scale-95"
                                >
            ...
            <div className="bg-white border-2 border-slate-50 rounded-[3rem] overflow-hidden shadow-2xl shadow-slate-200/40">
                <div className="bg-slate-50/50 border-b border-slate-100 px-10 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <span className="font-black text-slate-900 text-sm block">Registry Nodes</span>
                    ...
                    <div className="relative group w-full md:w-96">
                        ...
                        <input 
                            ...
                            className="w-full bg-white border-2 border-slate-100 rounded-2xl py-5 pl-14 pr-6 text-base font-bold outline-none focus:border-blue-500 transition-all"
                        />
                    </div>
                </div>
                ...
                <div className="divide-y-2 divide-slate-50">
                    {loading ? (
                        <div className="p-32 text-center space-y-6">
                            ...
                            <p className="text-slate-400 font-black text-sm">Accessing Database Infrastructure...</p>
                        </div>
                    ) : (
                                ...
                                <div key={cat._id} className="group px-10 py-8 flex items-center justify-between hover:bg-slate-50/50 transition-all">
                                    <div className="flex items-center gap-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-black text-slate-400 mt-1 tabular-nums italic">NODE ID: {cat._id.substring(18)}</p>
                                        </div>
                                    </div>
