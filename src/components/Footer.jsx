...
const Footer = () => {
  return (
    <footer className="bg-[#1a1a1a] text-white w-full">
      ...
      {/* TOP SECTION */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li><Link to="/" className="text-red-500 hover:text-red-400 transition">Home</Link></li>
            <li><Link to="/about/" className="text-gray-300 hover:text-white transition">About Us</Link></li>
            <li><Link to="/blogs/" className="text-gray-300 hover:text-white transition">Blog</Link></li>
            <li><Link to="/faq/" className="text-gray-300 hover:text-white transition">FAQ's</Link></li>
            <li><Link to="/contact-us/" className="text-gray-300 hover:text-white transition">Contact Us</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            <li><Link to="/privacy-policy/" className="text-gray-300 hover:text-white transition">Privacy Policy</Link></li>
            <li><Link to="/terms-and-conditions/" className="text-gray-300 hover:text-white transition">Terms and Conditions</Link></li>
            <li><Link to="/return-refund-policy/" className="text-gray-300 hover:text-white transition">Return and Refund Policy</Link></li>
            <li><Link to="/shipping-policy/" className="text-gray-300 hover:text-white transition">Shipping Policy</Link></li>
            <li><Link to="/disclaimer/" className="text-gray-300 hover:text-white transition">Disclaimer</Link></li>
          </ul>
        </div>
