            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-white p-6 rounded-xl border border-slate-200 hover:shadow-md transition-shadow">
                    ...
                    <button
                        ...
                        className="w-full px-4 py-2 bg-[#EF4056] text-white rounded-lg hover:bg-red-700 font-medium text-sm"
                    >
                        Start Chat
                    </button>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 hover:shadow-md transition-shadow">
                    ...
                    <a
                        href="mailto:support@smarteprintsolution.com"
                                ...
                                return (
                                    <div key={index} className={`flex ${isUser ? 'justify-end' : 'justify-start'}`}>
                                        <div className={`max-w-[80%] rounded-2xl px-4 py-2 text-sm ${isUser
                                            ...
                                            <p>{msg.message}</p>
                                            <div className={`text-[10px] mt-1 text-right ${isUser ? 'text-red-100' : 'text-slate-400'}`}>
